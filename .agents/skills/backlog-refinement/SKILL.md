...
```bash
python3 .agents/skills/backlog-refinement/scripts/bail-report.py        # all agent-bail:* issues
python3 .agents/skills/backlog-refinement/scripts/bail-report.py --since 2026-01-01  # window
```
