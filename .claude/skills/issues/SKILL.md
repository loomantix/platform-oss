...
This skill is generated upstream from `prompts/skills/issues/` into `.claude/skills/issues/`, then synced to consumer repos. Edit the upstream source; consumer and generated copies are overwritten.
