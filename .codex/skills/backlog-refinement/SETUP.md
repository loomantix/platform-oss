...
5. If `agent-loop-instructions.md` names a legacy rubric path, point it at `.codex/skills/backlog-refinement/core-rubric.md` and `.backlog/refinement.local.md` instead.
